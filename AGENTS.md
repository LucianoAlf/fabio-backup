...
**Fatiamento:** em aula de 1 aluno, o tronco é o próprio aluno e `fatia.progresso` deve ser preenchido normalmente quando o professor descreveu o trabalho. Em turma 2+, `tronco.atividades` é o comum da aula e `fatia.progresso` só entra com evidência individual daquele aluno; sem fala específica, fica `null`.
